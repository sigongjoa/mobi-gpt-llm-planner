...
export const DocumentDuplicateIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
...
export const PaintBrushIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MegaphoneIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const CubeTransparentIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v6M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25L3 7.5m18 0l-9 5.25L3 7.5M3 7.5v6.059c0 .532.22.999.553 1.344l8.36 7.21a1.25 1.25 0 001.69-.001l8.36-7.21A2.25 2.25 0 0021 13.559V7.5M3 7.5l9 5.25m-9-5.25l9 5.25" />
    </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-2.024a1.125 1.125 0 010-1.984l3.72-2.024zM4.224 21.006a2.25 2.25 0 01-.897-1.734v-4.286c0-.97.616-1.813 1.5-2.097l3.72 2.024a1.125 1.125 0 010 1.984l-3.72 2.024z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 12h-3M3.75 3v11.25A2.25 2.25 0 006 16.5h12A2.25 2.25 0 0020.25 14.25V5.25A2.25 2.25 0 0018 3H6a2.25 2.25 0 00-2.25 2.25z" />
    </svg>
);
